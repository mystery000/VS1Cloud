                ...
                $("#tblInventoryPayrollService")
                  .dataTable({
                    ...
                    fnInitComplete: function () {
                      ...
                      $(
                        "<button class='btn btn-primary' data-dismiss='modal' data-toggle='modal' data-target='#newProductModal' type='button' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-plus'></i></button>"
                      ).insertAfter("#tblInventoryPayrollService_filter");
                      $(
        ...
        if (dataObject.length == 0 || refresh) {
            ...
            .then(function (data) {
              ...
              for (let i = 0; i < data.tappointmentex.length; i++) {
                ...
                var appointment = {
                  ...
                  timelog:
                    data.tappointmentex[i].fields.AppointmentsTimeLog || "",
                  startTime:
                    data.tappointmentex[i].fields.StartTime.split(" ")[1] || "",
                  totalHours: data.tappointmentex[i].fields.TotalHours || 0,
                  endTime:
                    data.tappointmentex[i].fields.EndTime.split(" ")[1] || "",
                  ...
                  openbalance:
                    data.tappointmentex[i].fields.Actual_EndTime || "",
                  aStartTime:
                    data.tappointmentex[i].fields.Actual_StartTime.split(
                      " "
                    )[1] || "",
                  aEndTime:
                    data.tappointmentex[i].fields.Actual_EndTime.split(
                      " "
                    )[1] || "",
                  aStartDate:
                    data.tappointmentex[i].fields.Actual_StartTime.split(
              ...
              if (url.indexOf("?id") > 1) {
                ...
                if (result.length > 0) {
                  ...
                  if (!$("#smsConfirmedFlag i.fa-question").hasClass("d-none"))
                    $("#smsConfirmedFlag i.fa-question").addClass("d-none");
                  if (
                    !$("#smsConfirmedFlag i.fa-minus-circle").hasClass("d-none")
                  )
                    $("#smsConfirmedFlag i.fa-minus-circle").addClass("d-none");
                  if (result[0].custFld13 === "Yes") {
                    if (result[0].custFld11 === "Yes") {
              ...
              new Draggable(draggableEl, {
                ...
                eventData: function (eventEl) {
                  ...
                  return {
                    title: eventEl.innerText,
                    duration:
                      "0" + templateObject.empDuration.get() + ":00" || "01:00",
                  };
                },
              });
              //}
          ...
          for (let i = 0; i < useData.length; i++) {
            ...
            var appointment = {
              ...
              aStartTime:
                useData[i].fields.Actual_StartTime.split(" ")[1] || "",
              aEndTime: useData[i].fields.Actual_EndTime.split(" ")[1] || "",
              aStartDate:
                useData[i].fields.Actual_StartTime.split(" ")[0] || "",
          ...
          .then(function (data) {
            ...
            for (let i = 0; i < data.tappointmentex.length; i++) {
              ...
              var appointment = {
                ...
                aEndTime:
                  data.tappointmentex[i].fields.Actual_EndTime.split(" ")[1] ||
                  "",
                aStartDate:
                  data.tappointmentex[i].fields.Actual_StartTime.split(
                    " "
                ...
                aEndDate:
                  data.tappointmentex[i].fields.Actual_EndTime.split(" ")[0] ||
                  "",
                actualHours: "",
                closebalance: "",
                rate: data.tappointmentex[i].fields.Rate || 1,
        ...
        if (dataObject.length == 0) {
          clientsService.getClientVS1().then(function (data) {
            for (let i in data.tcustomervs1) {
              let customerrecordObj = {
                ...
                street:
                  data.tcustomervs1[i].Street.replace(
                    /(?:\r\n|\r|\n)/g,
                    ", "
                  ) || " ",
                ...
                suburb:
                  data.tcustomervs1[i].Suburb || data.tcustomervs1[i].Street2,
          ...
          for (let i in useData) {
            let customerrecordObj = {
              ...
              street:
                useData[i].fields.Street.replace(/(?:\r\n|\r|\n)/g, ", ") ||
                " ",
      ...
      if (updateData.length > 0) {
        objectData = {
          ...
          fields: {
            Id: parseInt(id) || 0,
            StartTime:
              allocDate + " " + updateData[0].startDate.split(" ")[1] || "",
            EndTime:
              allocDate + " " + updateData[0].endDate.split(" ")[1] || "",
...
Template.appointments.events({
  ...
  "click .btnAppointmentList": function (event) {
    ...
    if (id) {
      ...
      swal({
        title:
          "Appointment does not exist, create one first to view Appointment Timelist",
        text: err,
        type: "error",
        showCancelButton: false,
        confirmButtonText: "Try Again",
