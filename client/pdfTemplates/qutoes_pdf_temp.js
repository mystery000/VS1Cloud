...
Template.quotesPrintTemp.onCreated(()=>{
    ...
    templateObject.quoterecords = new ReactiveVar([])
})

Template.quotesPrintTemp.onRendered(()=>{
    const templateObject = Template.instance();
...
Template.quotesPrintTemp.helpers({
    quoterecords:()=>{
        return Template.instance().quoterecords.get();
    },
