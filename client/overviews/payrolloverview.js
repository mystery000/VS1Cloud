                ...
                $("#tblPayHistorylist")
                  .DataTable({
                    ...
                    fnInitComplete: function () {
                      ...
                      $(
                        "<button class='btn btn-primary btnRefreshPayRunList' type='button' id='btnRefreshPayRunList' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>"
...
Template.payrolloverview.helpers({
  ...
  payRunHistoryRecords: () => {
    return Template.instance().payRunHistoryRecords.get();
  },
  draftPayRunRecords: () => {
