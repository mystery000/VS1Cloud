...
Template.customerlistpop.onCreated(function () {
  ...
  let headerStructure = [
      ...
      { index: 5, label: "AR Balance", class: "colARBalance", active: true, display: true, width: "100" },
      ...
      { index: 9, label: "Order Balance", class: "colSalesOrderBalance", active: true, display: true, width: "115" },
      ...
      { index: 16, label: "Account No", class: "colAccountNo", active: false, display: true, width: "105" },
      ...
      { index: 19, label: "Term Name", class: "colCustomerTermName", active: false, display: true, width: "75" },
      ...
      { index: 22, label: "Tax Code", class: "colCustomerTaxCode", active: false, display: true, width: "85" },
      ...
      { index: 26, label: "Status", class: "colStatus", active: true, display: true, width: "100" },
  ];
  ...
  custdisplayfields: () => {
    ...
    tablename: () => {
      ...
      let selCustID = templateObject.data.custid ? templateObject.data.custid:'';
    	return 'tblCustomerlist'+selCustID;
    },
});
