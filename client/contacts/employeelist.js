                  ...
                  addVS1Data('TEmployee',JSON.stringify(data));
                    ...
                    setTimeout(function () {
                        $('#tblEmployeelist').DataTable({
                            ...
                            $("<button class='btn btn-primary btnRefreshEmployees' type='button' id='btnRefreshEmployees' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblEmployeelist_filter");
                        }
