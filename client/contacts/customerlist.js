                  ...
                  addVS1Data('TCustomerVS1',JSON.stringify(data));
                    ...
                    setTimeout(function () {
                        $('#tblCustomerlist').DataTable({
                            ...
                            $("<button class='btn btn-primary btnRefreshCustomers' type='button' id='btnRefreshCustomers' style='padding: 4px 10px; font-size: 16px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblCustomerlist_filter");
                        }
