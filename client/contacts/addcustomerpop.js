...
Template.addcustomerpop.onRendered( async function() {
    ...
    templateObject.getCustomerData = async function() {
        let lineItemObj = {
            id: '',
            lid: 'Add Customer',
            company: '',
...
Template.addcustomerpop.events({
    ...
    'keydown .addcustomerpop #custOpeningBalance, keydown .addcustomerpop #edtJobNumber, keydown .addcustomerpop #edtCustomerCardDiscount': function(event) {
        ...
        if ((event.keyCode >= 48 && event.keyCode <= 57) ||
            ...
            event.keyCode == 46 || event.keyCode == 190 || event.keyCode == 189) {} else {
            event.preventDefault();
        }
    },
