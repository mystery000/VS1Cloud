                    ...
                    contactService.getTermDataVS1().then((data) => {
                        for (let i = 0; i < data.ttermsvs1.length; i++) {
                            ...
                            if (data.ttermsvs1[i].isPurchasedefault == true) {
                                ...
                                templateObject.defaultpurchaseterm.set(
                                    data.ttermsvs1[i].TermsName
                                );
                            }
                        }
...
Template.addsupplierpop.events({
                ...
                .then(function(objDetails) {
                    ...
                    if (supplierSaveID) {
                        ...
                        if (
                            ...
                            $(".purchasesmodule #edtSupplierName").attr(
                                "custid",
                                supplierSaveID
                            );
                            var postalAddress =
                                ...
                                .then(function(dataReload) {
                                    addVS1Data("TSupplierVS1", JSON.stringify(dataReload))
                                        .then(function(datareturn) {
                                            $('.setup-wizard') ? $('.setup-wizard .setup-step-8 .btnRefresh').click() : location.reload();
                                        })
                                        .catch(function(err) {
                                            $('.setup-wizard') ? $('.setup-wizard .setup-step-8 .btnRefresh').click() : location.reload();
                                        });
    ...
    "change .addsupplierpop #attachment-upload": function(e) {
        ...
        let uploadData = utilityService.attachmentUploadTabs(
            uploadedFilesArray,
            myFiles,
            saveToTAttachment,
            lineIDForAttachment
