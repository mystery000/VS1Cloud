                    ...
                    setTimeout(function () {
                        $('#tblSupplierlist').DataTable({
                            ...
                            "fnInitComplete": function () {
                                $("<button class='btn btn-primary btnAddNewSupplier' data-dismiss='modal' data-toggle='modal' data-target='#addSupplierModal' type='button' style='padding: 4px 10px; font-size: 16px; margin-left: 12px !important;'><i class='fas fa-plus'></i></button>").insertAfter("#tblSupplierlist_filter");
                                $("<button class='btn btn-primary btnRefreshSupplier' type='button' id='btnRefreshSupplier' style='padding: 4px 10px; font-size: 16px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblSupplierlist_filter");
