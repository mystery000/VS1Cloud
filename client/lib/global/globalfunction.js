    ...
    oReq.onreadystatechange = function() {
        if(oReq.readyState == 4 && oReq.status == 200) {
          ...
          if (~responseBack.indexOf("Finished Batch Update")){
            ...
            oReq4.open("GET",URLRequest + erpGet.ERPIPAddress + ':' + erpGet.ERPPort + '/' + 'erpapi/TCardDataReport?SelDate="' + dateAsOf + '"', true);
            oReq4.setRequestHeader("database",erpGet.ERPDatabase);
            oReq4.setRequestHeader("username",erpGet.ERPUsername);
            oReq4.setRequestHeader("password",erpGet.ERPPassword);
            oReq4.send();
