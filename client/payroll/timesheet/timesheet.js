                    ...
                    for (let w = 0; w < data.ttimesheet.length; w++) {
                        ...
                        if (data.ttimesheet[w].fields.Logs) {
                            if (Array.isArray(data.ttimesheet[w].fields.Logs)) {
                                ...
                                description = data.ttimesheet[w].fields.Logs[data.ttimesheet[w].fields.Logs.length - 1].fields.Description || '';
                            } else {
                                lineEmpID = data.ttimesheet[w].fields.Logs.fields.EmployeeID || '';
                                description = data.ttimesheet[w].fields.Logs.fields.Description || '';
                            }
                        }
                        var dataList = {
