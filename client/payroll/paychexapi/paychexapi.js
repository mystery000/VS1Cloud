...
Template.paychexapi.onRendered(function () {
            ...
            $('#tblpaychex').DataTable({
              columnDefs: [
                  ...
                  buttons: [
                     ...
                     filename: "paychexlist_"+ moment().format(),
                  ...
                  "order": [[ 0, "asc" ]],
                  action: function () {
                      $('#tblpaychex').DataTable().ajax.reload();
                  },
...
Template.paychexapi.events({
  ...
  'click .resetTable' : function(event){
    ...
    if(getcurrentCloudDetails){
      if (getcurrentCloudDetails._id.length > 0) {
        ...
        var checkPrefDetails = CloudPreference.findOne({userid:clientID,PrefName:'tblpaychex'});
        if (checkPrefDetails) {
  ...
  'click .saveTable' : function(event){
    let lineItems = [];
    //let datatable =$('#tblpaychex').DataTable();
      ...
      if (getcurrentCloudDetails._id.length > 0) {
        ...
        if (checkPrefDetails) {
          CloudPreference.update({_id: checkPrefDetails._id},{$set: { userid: clientID,username:clientUsername,useremail:clientEmail,
            PrefGroup:'salesform',PrefName:'tblpaychex',published:true,
  ...
  'click .btnOpenSettings' : function(event){
    ...
    'click .exportbtn': function () {
      $('.fullScreenSpin').css('display','inline-block');
      jQuery('#tblpaychex_wrapper .dt-buttons .btntabletocsv').click();
       $('.fullScreenSpin').css('display','none');
    },
      'click .exportbtnExcel': function () {
        $('.fullScreenSpin').css('display','inline-block');
        jQuery('#tblpaychex_wrapper .dt-buttons .btntabletoexcel').click();
         $('.fullScreenSpin').css('display','none');
      },
