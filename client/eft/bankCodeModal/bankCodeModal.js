...
Template.bankCodeModal.onRendered(function () {
  ...
  $('#tblBankCode').dataTable({
    ...
    "fnInitComplete": function () {
      $("<button class='btn btn-primary btnAddNewBankCode' data-dismiss='modal' data-toggle='modal' data-target='#addBankCodeModal' type='button' style='padding: 4px 10px; font-size: 14px; margin-left: 8px !important;'><i class='fas fa-plus'></i></button>").insertAfter("#tblBankCode_filter");
      $("<button class='btn btn-primary btnRefreshBankCode' type='button' id='btnRefreshBankCode' style='padding: 4px 10px; font-size: 14px; margin-left: 8px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblBankCode_filter");
    }
  });
