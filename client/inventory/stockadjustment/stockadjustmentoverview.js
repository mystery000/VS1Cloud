...
Template.stockadjustmentoverview.onCreated(function () {
  ...
  templateObject.getDataTableList = function (data) {
    ...
    let dataList = [
      ...
      data.fields.AdjustmentDate != ""? moment(data.fields.AdjustmentDate).format("DD/MM/YYYY"): data.fields.AdjustmentDate,
...
Template.stockadjustmentoverview.onRendered(function () {
  ...
  //                         $("<button class='btn btn-primary btnRefreshStockAdjustment' type='button' id='btnRefreshStockAdjustment' style='padding: 4px 10px; font-size: 16px; margin-left: 14px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblStockAdjustOverview_filter");
  //                     }
...
Template.stockadjustmentoverview.helpers({
  ...
  salesCloudPreferenceRec: () => {
    return CloudPreference.findOne({
      ...
      PrefName: "tblStockAdjustOverview",
    });
  },
  currentdate: () => {
  ...
  apiFunction: function () {
    ...
    return sideBarService.getAllStockAdjustEntry;
  },
