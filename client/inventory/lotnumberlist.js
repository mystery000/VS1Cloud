            ...
            setTimeout(function() {
                $('#tblLotNumberList').DataTable({
                    ...
                    "fnInitComplete": function() {
                        ...
                        $("<button class='btn btn-primary btnRefreshStockAdjustment' type='button' id='btnRefreshStockAdjustment' style='padding: 4px 10px; font-size: 14px; margin-left: 8px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblLotNumberList_filter");
                    }
