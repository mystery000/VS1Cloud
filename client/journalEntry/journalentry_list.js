                ...
                $('#tblJournalList').DataTable({
                      ...
                      "fnInitComplete": function () {
                        ...
                        if(data.Params.Search.replace(/\s/g, "") == ""){
                         ...
                         $("<button class='btn btn-primary btnRefreshJournalEntry' type='button' id='btnRefreshJournalEntry' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblJournalList_filter");
