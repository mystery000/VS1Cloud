            ...
            setTimeout(function() {
                $('#tblBasReturnTransactionList').DataTable({
                    ...
                    fnInitComplete: function() {
                        ...
                        $("<button class='btn btn-primary btnRefreshTrans' type='button' id='btnRefreshTrans' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblBasReturnTransactionList_filter");
                    }
