...
Template.dsmResalescomparision.onCreated(() => {
...
Template.dsmResalescomparision.onRendered(() => {
    ...
    if (checkStatus == false || checkStatus == "false") {
        $("#dsmResalecomparision").addClass('hideelement');
        $('#dsmResalehide').text("Show");
    } else {
        $("#dsmResalecomparision").removeClass('hideelement');
        $('#dsmResalehide').text("Hide");
    }
    ...
    getInvSales(function(data) {
        ...
        setTimeout(function() {
            ...
            var ctx = document.getElementById("dsmEmployeeSalesComparisonChart").getContext("2d");
...
Template.dsmResalescomparision.events({
...
Template.dsmResalescomparision.helpers({
    dateAsAt: () => {
