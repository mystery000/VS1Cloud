...
Template.dsmTop10Customers.onCreated(function() {
    const templateObject = Template.instance();

    templateObject.topTenData = new ReactiveVar([]);
});

Template.dsmTop10Customers.onRendered(function() {
    const templateObject = Template.instance();
    let topTenData1 = [];
    let topData = this;
    ...
    getInvSales(function(data) {
        setTimeout(function() {
            ...
            // Chart.js
            var ctx = document.getElementById("dsmTop10Customers").getContext("2d");
...
Template.dsmTop10Customers.helpers({
    topTenData: () => {
