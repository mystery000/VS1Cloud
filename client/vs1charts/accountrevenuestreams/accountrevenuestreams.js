...
Template.accountrevenuestreams.onRendered(() => {
  ...
  if (!localStorage.getItem("VS1PNLPeriodReport_dash")) {
    getInvSales(function (data) {
      ...
      var fromDate =
        currentBeginDate.getFullYear() + "-" + fromDateMonth + "-01";
      ...
      vs1chartService
        .getProfitLossPeriodReportData(prevMonth7, fromDate)
        .then((data) => {
          setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      var myChart = new Chart(ctx, {
        type: "line",
        data: {
          labels: [month_1, month_2, month_3, month_4, month_5, month_6, month_7],
          datasets: [
            {
              label: "Sales",
              fill: true,
