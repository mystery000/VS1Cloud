...
Template.worksheetreport.onCreated(() => {
  const templateObject = Template.instance();
  templateObject.dateAsAt = new ReactiveVar();
  templateObject.records = new ReactiveVar([]);
  templateObject.reportOptions = new ReactiveVar([]);
  templateObject.suppliersummaryth = new ReactiveVar([]);

  FxGlobalFunctions.initVars(templateObject);
});

Template.worksheetreport.onRendered(() => {
  const templateObject = Template.instance();
  LoadingOverlay.show();
...
Template.worksheetreport.events({
...
Template.worksheetreport.helpers({
  suppliersummaryth: () => {
    return Template.instance().suppliersummaryth.get();
  },
  dateAsAt: () => {
