...
Template.supplierreport.onRendered(() => {
  ...
  let reset_data = [
    ...
    { index: 2, label: 'Contact Name', class: 'colContactName', active: true, display: true, width: "130" },
    { index: 3, label: 'Phone', class: 'colPhone', active: true, display: true, width: "90" },
    { index: 4, label: 'Mobile', class: 'colMobile', active: true, display: true, width: "90" },
    ...
    { index: 8, label: 'Balance', class: 'colBalance', active: true, display: true, width: "90" },
    ...
    { index: 11, label: 'State', class: 'colState', active: true, display: true, width: "80" },
    ...
    { index: 14, label: 'Bank Account Name', class: 'colBankAccountName', active: true, display: true, width: "130" },
    { index: 15, label: 'Bank Account BSB', class: 'colBankAccountBSB', active: true, display: true, width: "130" },
    { index: 16, label: 'Bank Account No', class: 'colAccountNo', active: true, display: true, width: "130" },
    { index: 17, label: 'Creation Date', class: 'colCreationDate', active: true, display: true, width: "120" },
    { index: 18, label: 'Active', class: 'colActive', active: true, display: true, width: "80" },
    { index: 19, label: 'Global Ref', class: 'colGlobalRef', active: false, display: true, width: "100" },
    { index: 20, label: 'Street2', class: 'colStreet2', active: false, display: true, width: "90" },
    { index: 21, label: 'Street3', class: 'colStreet3', active: false, display: true, width: "90" },
    { index: 22, label: 'No Staff', class: 'colNoStaff', active: false, display: true, width: "90" },
    { index: 23, label: 'Min Inv value', class: 'colMinInvValue', active: false, display: true, width: "120" },
    { index: 24, label: 'Freight to Store', class: 'colFrighttoStore', active: false, display: true, width: "120" },
    { index: 25, label: 'Rebate', class: 'colRebate', active: false, display: true, width: "90" },
    ...
    { index: 28, label: 'Contact Details', class: 'colContractDetails', active: false, display: true, width: "120" },
    { index: 29, label: 'ABN', class: 'colABN', active: false, display: true, width: "70" },
