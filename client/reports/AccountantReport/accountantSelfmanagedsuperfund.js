...
Template.accountant_selfmanagedsuperfund.onRendered(() => {
...
Template.accountant_selfmanagedsuperfund.events({
                                    ...
                                    .then(function(data) {
                                        ...
                                        sideBarService.getAccountListVS1().then(function(dataReload) {
                                            addVS1Data("TAccountVS1", JSON.stringify(dataReload)).then(function(datareturn) {
                                                window.open("/accountant_selfmanagedsuperfund", "_self");
                                            }).catch(function(err) {
                                                window.open("/accountant_selfmanagedsuperfund", "_self");
                                            });
                                        }).catch(function(err) {
    ...
    "click .btnExportReport": function() {
        ...
        var opt = {
            margin: 0.8,
            filename: 'accountant-selfmanagedsuperfund.pdf',
            image: {
                type: 'jpeg',
                quality: 0.98
            },
...
Template.accountant_selfmanagedsuperfund.helpers({
