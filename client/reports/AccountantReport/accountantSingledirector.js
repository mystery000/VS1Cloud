...
Template.accountant_singledirector.onCreated(() => {
...
Template.accountant_singledirector.onRendered(() => {
...
Template.accountant_singledirector.events({
                                    ...
                                    .then(function(data) {
                                        ...
                                        sideBarService.getAccountListVS1().then(function(dataReload) {
                                            addVS1Data("TAccountVS1", JSON.stringify(dataReload)).then(function(datareturn) {
                                                window.open("/accountant_singledirector", "_self");
                                            }).catch(function(err) {
                                                window.open("/accountant_singledirector", "_self");
                                            });
                                        }).catch(function(err) {
    ...
    "click .btnPrintReport": function(event) {
        ...
        $(".printReport").show();
        $("a").attr("href", "/");
        document.title = "Single Director";
        $(".printReport").print({
    ...
    "click .btnExportReport": function() {
        ...
        var opt = {
            margin: 0.8,
            filename: 'accountant-singledirector.pdf',
            image: {
                type: 'jpeg',
                quality: 0.98
            },
...
Template.accountant_singledirector.helpers({
