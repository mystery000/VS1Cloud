...
import './accountantTrustnontrading.html';
...
Template.accountant_trustnontrading.events({
                                    ...
                                    .then(function(data) {
                                        ...
                                        sideBarService.getAccountListVS1().then(function(dataReload) {
                                            addVS1Data("TAccountVS1", JSON.stringify(dataReload)).then(function(datareturn) {
                                                window.open("/accountant_trustnontrading", "_self");
                                            }).catch(function(err) {
                                                window.open("/accountant_trustnontrading", "_self");
                                            });
                                        }).catch(function(err) {
    ...
    "click .btnPrintReport": function(event) {
        ...
        $(".printReport").show();
        $("a").attr("href", "/");
        document.title = "Trust Non Trading";
        $(".printReport").print({
    ...
    "click .btnExportReport": function() {
        ...
        var opt = {
            margin: 0.8,
            filename: 'accountant-trustnontrading.pdf',
            image: {
                type: 'jpeg',
                quality: 0.98
            },
