...
Template.accountant_individual.onCreated(() => {
...
Template.accountant_individual.onRendered(() => {
...
Template.accountant_individual.events({
                                    ...
                                    .then(function(data) {
                                        ...
                                        sideBarService.getAccountListVS1().then(function(dataReload) {
                                            addVS1Data("TAccountVS1", JSON.stringify(dataReload)).then(function(datareturn) {
                                                window.open("/accountant_individual", "_self");
                                            }).catch(function(err) {
                                                window.open("/accountant_individual", "_self");
                                            });
                                        }).catch(function(err) {
    ...
    'click .btnselAccountant': function(event) {
        ...
        for (var i = 0; i < accountantList.length; i++) {
            if ($("#f-" + accountantPanID + "-" + accountantList[i].id).prop('checked') == true) {
                ...
                innerHtml += "<div style='width:calc(100% - 90px); float:left; padding-top:4px'>" + accountantList[i].accountname + "</div>";
    ...
    "click .btnExportReport": function() {
        ...
        var opt = {
            margin: 0.8,
            filename: 'accountant-individual.pdf',
            image: {
                type: 'jpeg',
                quality: 0.98
            },
