...
Template.salesreport.onRendered(() => {
  ...
  let reset_data = [
    ...
    { index: 2, label: 'Sale Date', class: 'colSaleDate', active: true, display: true, width: "" },
    { index: 3, label: 'Invoice~Number', class: 'colInvoiceNumber', active: true, display: true, width: "" },
    { index: 4, label: 'Transaction~Type', class: 'colTransactionType', active: true, display: true, width: "" },
    { index: 5, label: 'Customer~Type', class: 'colCustomerType', active: true, display: true, width: "" },
    { index: 6, label: 'Amount(Ex)', class: 'colAmountEx', active: true, display: true, width: "" },
    { index: 7, label: 'Tax', class: 'colTax', active: true, display: true, width: "" },
    { index: 8, label: 'Amount(Inc)', class: 'colAmountInc', active: true, display: true, width: "" },
    { index: 9, label: 'Qty Shipped', class: 'colQtyShipped', active: true, display: true, width: "" },
    { index: 10, label: 'UOM', class: 'colUOM', active: false, display: true, width: "" },
    { index: 11, label: 'Product ID', class: 'colProductID', active: true, display: true, width: "" },
    { index: 12, label: 'Catagory', class: 'colCatagory', active: true, display: true, width: "" },
    { index: 13, label: 'Switch', class: 'colSwitch', active: true, display: true, width: "" },
    { index: 14, label: 'Dept', class: 'colDept', active: true, display: true, width: "" },
    { index: 15, label: 'Description', class: 'colDescription', active: true, display: true, width: "" },
    { index: 16, label: 'Employee~Name', class: 'colEmployeeName', active: true, display: true, width: "" },
    { index: 17, label: 'Ship Date', class: 'colShipDate', active: true, display: true, width: "" },
    { index: 18, label: 'Ex', class: 'colEx', active: false, display: true, width: "" },
    { index: 19, label: 'Inc', class: 'colInc', active: false, display: true, width: "" },
    { index: 20, label: 'Ex', class: 'colEx', active: false, display: true, width: "" },
    { index: 21, label: 'Inc', class: 'colInc', active: false, display: true, width: "" },
    { index: 22, label: 'Ex', class: 'colEx', active: false, display: true, width: "" },
    { index: 23, label: 'Tax Code', class: 'colTaxCode', active: true, display: true, width: "" },
    { index: 24, label: 'Line Tax', class: 'colLineTax', active: true, display: true, width: "" },
    { index: 25, label: 'Ex', class: 'colEx', active: false, display: true, width: "" },
    { index: 26, label: 'Inc', class: 'colInc', active: false, display: true, width: "" },
    { index: 27, label: 'Discount $', class: 'colDiscountdollar', active: true, display: true, width: "" },
    { index: 28, label: 'Discount %', class: 'colDiscountpercent', active: true, display: true, width: "" },
    { index: 29, label: 'Percent', class: 'colPercent', active: true, display: true, width: "" },
    { index: 30, label: 'Gross', class: 'colGross', active: true, display: true, width: "" },
    { index: 31, label: 'Till', class: 'colTill', active: true, display: true, width: "" },
    { index: 32, label: 'Area', class: 'colArea', active: true, display: true, width: "" },
    { index: 33, label: 'Department Name', class: 'colDepartment', active: true, display: true, width: "" },
    { index: 34, label: 'Source', class: 'colSource', active: true, display: true, width: "" },
    { index: 35, label: 'Type', class: 'colType', active: true, display: true, width: "" },
    { index: 36, label: 'Sale Id', class: 'colSaleID', active: false, display: true, width: "" },
    { index: 37, label: 'Due Date', class: 'colDueDate', active: false, display: true, width: "" },
    { index: 38, label: 'Sales Ref No', class: 'colSalesRefNo', active: false, display: true, width: "" },
    { index: 39, label: 'Shipped To~ Address', class: 'colShippedToAddress', active: false, display: true, width: "" },
    { index: 40, label: 'Time of Sale', class: 'colTimeofSale', active: false, display: true, width: "" },
    { index: 41, label: 'Memo', class: 'colMemo', active: false, display: true, width: "" },
    { index: 42, label: 'Comments', class: 'colComments', active: false, display: true, width: "" },
    { index: 43, label: 'Original No', class: 'colOriginalNo', active: false, display: true, width: "" },
    { index: 44, label: 'PO Number', class: 'colPONumber', active: false, display: true, width: "" },
    { index: 45, label: 'Consignment~ Note', class: 'colConsignmentNote', active: false, display: true, width: "" },
    { index: 46, label: 'Lines Ref No', class: 'colLinesRefNo', active: false, display: true, width: "" },
    { index: 47, label: 'Preferred Supplier', class: 'colPreferredSupplier', active: false, display: true, width: "" },
    { index: 48, label: 'Supplier Product code', class: 'colSupplierProductCode', active: false, display: true, width: "" },
    { index: 49, label: 'POS Source', class: 'colPOSSource', active: false, display: true, width: "" },
    { index: 50, label: 'Warranty Ends On', class: 'colWarrantyEnsOn', active: false, display: true, width: "" },
    { index: 51, label: 'Warranty Period', class: 'colWarrantyPeriod', active: false, display: true, width: "" },
    { index: 52, label: 'POS Post Code', class: 'colPOSPostCode', active: false, display: true, width: "" },
    { index: 53, label: 'Line~ Ship date', class: 'colLineShipDate', active: false, display: true, width: "" },
    { index: 54, label: 'Markup $', class: 'colMarkupdollar', active: false, display: true, width: "" },
    { index: 55, label: 'Markup %', class: 'colMarkuppercent', active: false, display: true, width: "" },
    { index: 56, label: 'Run Name', class: 'colRunName', active: false, display: true, width: "" },
    { index: 57, label: 'Print Name', class: 'colPrintName', active: false, display: true, width: "" },
    { index: 58, label: 'Globalref', class: 'colGlobalref', active: false, display: true, width: "" },
  ];
