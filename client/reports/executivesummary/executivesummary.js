...
Template.executivesummaryreport.onRendered(() => {
  ...
  templateObject.getExecutiveSummaryReports = async (dateAsOf) => {
    LoadingOverlay.show();

    let data = !localStorage.getItem("VS1BalanceSheet_Report1")
      ? await reportService.getExecutiveSummaryReport(dateAsOf)
  ...
  templateObject.getExecutiveSummaryReports(getLoadDate);
...
Template.executivesummaryreport.events({
  ...
  "click .update_search": function () {
    ...
    templateObject.getExecutiveSummaryReports(Date);
    let url =
  ...
  "change .balancedate": function () {
    ...
    templateObject.getExecutiveSummaryReports(formatBalDate);
  ...
  "click .lastMonth": function () {
    ...
    templateObject.getExecutiveSummaryReports(formatDateTo);
  ...
  "click #lastQuarter": function () {
    ...
    templateObject.getExecutiveSummaryReports(getDateFrom);
  },
  ...
  "click #ignoreDate": function () {
    ...
    templateObject.getExecutiveSummaryReports("", "", true);
  },
  ...
  "click .btnExportReport": function () {
    ...
    const filename = loggedCompany + "-Executive Summary" + ".csv";
    utilityService.exportReportToCsvTable("tableExport", filename, "csv");
    let rows = [];
    // reportService.getExecutiveSummaryReport(formatBalDate).then(function (data) {
    //     if(data.balancesheetreport){
