    ...
    if (settingObject.length) {
      ...
      try {
        ...
        if (ApiResponse.result == "Success") {
          ...
          swal({title: "XE Currency settings successfully updated!", text: "", type: "success", showCancelButton: false, confirmButtonText: "OK"});
        } else {
          $(".fullScreenSpin").css("display", "none");
          swal({title: "Oooops...", text: "Error in updation", type: "error", showCancelButton: false, confirmButtonText: "Try Again"});
        }
      } catch (error) {
        $(".fullScreenSpin").css("display", "none");
