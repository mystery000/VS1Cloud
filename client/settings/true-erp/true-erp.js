...
import "./true-erp.html";
let _ = require("lodash");
Template.trueerp.onRendered(function () {
  var erpGet = erpDb();
  let objDetailsUser = {
  ...
  oPost.open(
    ...
    URLRequest +
      ...
      loggedserverPort +
      "/" +
      'erpapi/VS1_Cloud_Task/Method?Name="VS1_DbConnectTest"',
    true
  );
    ...
    setTimeout(function () {
      ...
      oPost.open(
        ...
        URLRequest +
          ...
          loggedserverPort +
          "/" +
          'erpapi/VS1_Cloud_Task/Method?Name="VS1_ChangeDatabase"',
        true
      );
      oPost.setRequestHeader("database", vs1loggedDatatbase);
      oPost.setRequestHeader("username", "VS1_Cloud_Admin");
        ...
        if (oPost.readyState == 4 && oPost.status == 200) {
          ...
          if (myArrResponse.ProcessLog.Error) {
            ...
            swal({
              ...
              if (getLasTDatabase) {
                deleteStoreDatabase(getLasTDatabase)
                  .then(function (data) {
                    window.open("/", "_self");
                  })
                  .catch(function (err) {
            ...
            if (data.temployee.length > 0) {
              for (let i = 0; i < data.temployee.length; i++) {
                ...
                if (data.temployee[i].fields.User != null) {
                  ...
                  let cloudpassword =
                    data.temployee[i].fields.User.fields.LogonPassword || "";
                  ...
                  var enteredPassword =
                    data.temployee[i].fields.User.fields.LogonPassword || "";
                  var cloudHashPassword = CryptoJS.MD5(
                  ...
                  if (data.temployee[i].fields.Email != "") {
                    ...
                    let objDetailsUser = {
                      ...
                      Params: {
                        ...
                        // Paymentamount:35,
                        Paymentamount:
                          Number(addExtraUserPrice.replace(/[^0-9.-]+/g, "")) ||
                          35,
                        PayMethod: "Cash",
                        Price:
                          Number(addExtraUserPrice.replace(/[^0-9.-]+/g, "")) ||
                        ...
                        RenewPrice:
                          Number(addExtraUserPrice.replace(/[^0-9.-]+/g, "")) ||
                          35,
                        RenewDiscountedPrice:
                          Number(addExtraUserPrice.replace(/[^0-9.-]+/g, "")) ||
                          35,
                        RenewDiscountDesc:
                          "Free User Included in the license - TrueERP Users",
                        // PayMethod:"Cash",
                        EmployeeDetails: {
                    ...
                    oPost.open(
                      ...
                      URLRequest +
                        ...
                        loggedserverPort +
                        "/" +
                        'erpapi/VS1_Cloud_Task/Method?Name="VS1_NewUser"',
                      true
                    );
                    oPost.setRequestHeader("database", vs1loggedDatatbase);
                    oPost.setRequestHeader("username", "VS1_Cloud_Admin");
                    ...
                    var myString =
                      '"JsonIn"' + ":" + JSON.stringify(objDetailsUser);
                    oPost.send(myString);
