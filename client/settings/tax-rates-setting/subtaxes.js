...
Template.subTaxesSettings.onCreated(function () {
  ...
  let headerStructure = [
    // { index: 0, label: "Id", class: "colCode", active: true, display: true, width: "100" },
    { index: 0, label: "Code", class: "colCode", active: true, display: true, width: "100" },
    { index: 1, label: "Description", class: "colDescription", active: true, display: true },
    { index: 2, label: "Category", class: "colCategory", active: true, display: true, width: "150" },
    { index: 3, label: "", class: "colDelete", active: true, display: true, width: "100" }
  ];
...
Template.subTaxesSettings.onRendered(function () {
  ...
  //           var dataList = [
  //             data.tsubtaxcode[i].Id || '',
  //             data.tsubtaxcode[i].Code || '-',
  //             data.tsubtaxcode[i].Description || '-',
  //             data.tsubtaxcode[i].Category || '-'
  //           ];
...
Template.subTaxesSettings.helpers({
  ...
  apiFunction:function() { // do not use arrow function
    return taxRateService.getSubTaxCode
  },
  ...
  searchAPI: function() {
    return taxRateService.getOneGroupTypeByName
  },
