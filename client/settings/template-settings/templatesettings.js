...
Template.templatesettings.onRendered(function () {
      ...
      .then(function (dataObject) {
        if (dataObject.length == 0) {
            ...
            .then(function (data) {
              ...
              for (let i = 0; i < data.ttemplatesettings.length; i++) {
                ...
                if (
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Customer Payments_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 2) {
                    $('input[name="Customer Payments_2"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 3) {
                    $('input[name="Customer Payments_3"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                ...
                if (
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Customer Statements_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 2) {
                    $('input[name="Customer Statements_2"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 3) {
                    $('input[name="Customer Statements_3"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                ...
                if (
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Purchase Orders_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 2) {
                    $('input[name="Purchase Orders_2"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 3) {
                    $('input[name="Purchase Orders_3"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                ...
                if (
                  data.ttemplatesettings[i].fields.SettingName == "Sales Orders"
                ) {
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Sales Orders_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                ...
                if (
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Supplier Payments_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 2) {
                    $('input[name="Supplier Payments_2"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                  ...
                  if (data.ttemplatesettings[i].fields.Template == 3) {
                    $('input[name="Supplier Payments_3"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
                ...
                if (
                  data.ttemplatesettings[i].fields.SettingName == "Statements"
                ) {
                  if (data.ttemplatesettings[i].fields.Template == 1) {
                    $('input[name="Statements_1"]').val(
                      data.ttemplatesettings[i].fields.Description
                    );
                    if (data.ttemplatesettings[i].fields.Active == true) {
          ...
          for (let i = 0; i < data.ttemplatesettings.length; i++) {
            ...
            if (
              data.ttemplatesettings[i].fields.SettingName == "Purchase Orders"
            ) {
              if (data.ttemplatesettings[i].fields.Template == 1) {
                $('input[name="Purchase Orders_1"]').val(
                  data.ttemplatesettings[i].fields.Description
  ...
  function showBillData(template_title, number) {
    ...
    function showSealsOrder(template_title,number) {
        ...
        saveTemplateFields("fields" + template_title , object_invoce[0]["fields"]);
>>>>>>> d48dd8c109d80b5416271e5ace01b696aef776ae
    }
  ...
  function showSealsOrder(template_title, number) {
    object_invoce = [];
    var array_data = [];
    array_data.push(["Test", "Test description", "2", "$0", "$0.00", "$0.00"]);
  ...
  function showJournalEntry(template_title, number) {
    object_invoce = [];
    var array_data = [];
    array_data.push(["Bank", "Bank", "$700.00", "$0.00"]);
    array_data.push([
      "Bank Charges",
      "Bank Charges and Fees",
      "$0.00",
  ...
  function showDepositData(template_title, number) {
    object_invoce = [];
    var array_data = [];
    array_data.push(["Bank", "Cheque", "", "Received From", "-$900.00"]);
...
Template.templatesettings.events({
  ...
  "click .btnTopGlobalSave": function () {
    ...
    setTimeout(function () {
      ...
      var customer_statement = $(
        'input[name="Customer Statements"]:checked'
      ).val();
      ...
      sideBarService
        .getTemplateNameandEmployeId("bill", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("bill", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Payments", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Payments", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Payments", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Statements", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Statements", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Customer Statements", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Purchase Orders", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Purchase Orders", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Purchase Orders", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Quotes", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Quotes", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Quotes", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Supplier Payments", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Supplier Payments", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Supplier Payments", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Statements", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Statements", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Statements", emid, 3)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Journal Entry", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Journal Entry", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Journal Entry", emid, 3)
        .then(function (data) {
          $(".fullScreenSpin").css("display", "none");
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
      ...
      sideBarService
        .getTemplateNameandEmployeId("Deposits", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Deposits", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Deposits", emid, 3)
        .then(function (data) {
          $(".fullScreenSpin").css("display", "none");
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
      ...
      sideBarService
        .getTemplateNameandEmployeId("Cheques", emid, 1)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Cheques", emid, 2)
        .then(function (data) {
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
          objDetails = {
      ...
      sideBarService
        .getTemplateNameandEmployeId("Cheques", emid, 3)
        .then(function (data) {
          $(".fullScreenSpin").css("display", "none");
          templateid = data.ttemplatesettings;
          var id = templateid[0].fields.ID;
