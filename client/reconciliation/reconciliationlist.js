...
Template.reconciliationlist.onCreated(function(){
    ...
    templateObject.getDataTableList = function(data) {
        let openBalance = utilityService.modifynegativeCurrencyFormat(data.OpenBalance)|| 0.00;
        let closeBalance = utilityService.modifynegativeCurrencyFormat(data.CloseBalance)|| 0.00;
        var dataList = [
            //data.ReconciliationID || '',
            data.ReconciliationDate !=''? moment(data.ReconciliationDate).format("DD/MM/YYYY"): data.ReconciliationDate,
            data.AccountName || '',
            data.StatementNo || '',
            data.ReconciliationID || '',
            data.Department|| '',
...
Template.reconciliationlist.helpers({
    ...
    searchAPI: function() {
        return sideBarService.getAllTReconcilationByName;
    },
