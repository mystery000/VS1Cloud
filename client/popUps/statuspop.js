...
Template.statuspop.onCreated(function() {
    ...
    templateObject.getDataTableList = function(data){
        ...
        var dataList = [
            data.Id || '',
            data.TypeName || '',
            data.Description || data.TypeName,
            eqpm,
            linestatus
        ];
        return dataList;
    ...
    let headerStructure  = [
        ...
        { index: 1, label: 'Status Name', class: 'colStatusName', active: true, display: true, width: "200" },
        { index: 2, label: 'Description', class: 'colDescription', active: true, display: true, width: "500" },
        { index: 3, label: 'Expected Quantity per Month', class: 'colQuantity', active: true, display: true, width: "110" },
...
Template.statuspop.events({
    'click .btnAddNewStatus' : function() {
        let modal = $('#newStatusPopModal');
        modal.find('#newStatus').val('');
        modal.find('#description').val('');
        modal.find('#quantity').val(0);
    },
});
...
Template.statuspop.helpers({
    ...
    tablename: function() {
        let templateObject = Template.instance();
        return "tblStatusPopList" + templateObject.data.custid;
    },
});
