            ...
            .then(function (data) {
              ...
              for (let i = 0; i < data.tleadstatustype.length; i++) {
                ...
                var dataList = {
                  ...
                  description:
                    data.tleadstatustype[i].Description ||
                    data.tleadstatustype[i].TypeName,
                };
                ...
                $("#tblStatusPopList")
                  .DataTable({
                    ...
                    fnInitComplete: function () {
                      $(
                        "<button class='btn btn-primary btnAddNewStatus' data-dismiss='modal' data-toggle='modal' data-target='#newStatusPopModal' type='button' style='padding: 4px 10px; font-size: 16px; margin-left: 12px !important;'><i class='fas fa-plus'></i></button>"
                      ).insertAfter("#tblStatusPopList_filter");
                      $(
                        "<button class='btn btn-primary btnRefreshStatus' type='button' id='btnRefreshStatus' style='padding: 4px 10px; font-size: 16px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>"
                      ).insertAfter("#tblStatusPopList_filter");
                    },
                  })
                  .on("page", function () {
