...
Template.wastage_form_template.onRendered(async function() {
    const templateObject = Template.instance();
...
Template.wastage_form_template.events({
...
Template.wastage_form_template.helpers({
    initialRecord: ()=>{
