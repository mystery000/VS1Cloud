            ...
            salesService.getLastInvoiceID().then(function(data) {
              let latestInvoiceId;
                ...
                setTimeout(function() {
                    ...
                    $(".heading").html("New Invoice " +newInvoiceId +'<a role="button" data-toggle="modal" href="#helpViewModal" style="font-size: 20px;">Help <i class="fa fa-question-circle-o" style="font-size: 20px;"></i></a>');
                    };
                }, 50);
            }).catch(function(err) {
                $('#sltDept').val(lastDepartment);
                                ...
                                if (useData[d].fields.Lines.length) {
                                    for (let i = 0; i < useData[d].fields.Lines.length; i++) {
                                        ...
                                        lineItemObj = {
                                            ...
                                            UnitOfMeasure: useData[d].fields.Lines[i].fields.UnitOfMeasure || defaultUOM,
