...
Template.billcard.onRendered(() => {
    ...
    templateObject.generateInvoiceData = function (template_title,number) {
        ...
        switch (template_title) {
         ...
         case "Bills":
            showBillData1(template_title,number);
           break;
        }
                    ...
                    if (splashArrayProductList) {
                        ...
                        $('#tblAccount').dataTable({
                            ...
                            "fnInitComplete": function() {
                                $("<button class='btn btn-primary btnRefreshAccount' type='button' id='btnRefreshAccount' style='padding: 4px 10px; font-size: 14px; margin-left: 12px !important;'><i class='fas fa-search-plus' style='margin-right: 5px'></i>Search</button>").insertAfter("#tblAccount_filter");
                            }
